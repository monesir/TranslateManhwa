...
contextBridge.exposeInMainWorld("florisApi", {
  ...
  deleteOcrResults: invoke("ocr:deleteResults"),
  ...
  updateTextComposition: invoke("data:updateTextComposition"),
  createTextStylePreset: invoke("data:createTextStylePreset"),
  updateTextStylePreset: invoke("data:updateTextStylePreset"),
  deleteTextStylePreset: invoke("data:deleteTextStylePreset"),
  applyTextStylePresetToSameKind: invoke("data:applyTextStylePresetToSameKind"),
  ...
  listAiTranslationProviders: invoke("translation:aiProviders"),
  translateWithAi: invoke("translation:ai"),
